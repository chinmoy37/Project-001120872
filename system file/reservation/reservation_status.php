          ...
          <div class="widget wgreen">
                ...
                <div class="widget-content">
                  <div class="padd" style="height:650px">
                    ...
                    <h3 style="text-align:center">Cafeteria catering  service</h3>
<h4 style="text-align:center">New Market</h4>
<h4 style="text-align:center">Tel. No.: 01988149800</h4>
<h4 style="text-align:center">Email:Cafeteriacatering@gmail.com</h4>
<h4 style="text-align:center">Facebook : facebook.com/Cafeteriacatering</h4>
<hr>
...
include('includes/dbcon.php');
	...
	$row="";
	//$query=mysqli_query($con,"select * from reservation left join team on reservation.team_id=team.team_id natural join combo where r_code='$rcode'");
	$query=mysqli_query($con,"SELECT r.*, c.combo_name FROM reservation r, combo c WHERE r.combo_id = c.combo_id AND r.r_code ='$rcode'");
...
<div style="width:50%;float:left">
  ...
  <span>No. of persons: <?php echo $row['pax'];?> * <?php echo $row['price'];?><?php if($motif =='daily') {?> * 26 Days <?php }?> = <?php echo $row['payable'];?> </span>
  <ul>
