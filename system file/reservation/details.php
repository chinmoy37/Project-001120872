...
<body>
                    ...
                    <!-- Form starts.  -->
                     <form class="form-horizontal" role="form" action="details_save.php" method="post">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-lg-5">
                                    <input  name='date' id='datepicker' value='' />
                                  </div>
                                    <span class = "label label-warning">Check date </span>
                                  </div>
								...
								<div class="form-group">
                                  <label class="col-lg-2 control-label">Booking Type</label>
                                  <div class="col-lg-5">
                                     <select class="form-control select2 " id="exampleSelect1" onchange="bookchange();" name="motif"  required>
                                ...
                                <div id="occasion" class="form-group">
                                  <label class="col-lg-2 control-label">Occasion</label>
                                  <div class="col-lg-5">
                                    <select class="form-control select2 occasion" id="exampleSelect1" name="ocassion" placeholder="Select occasion" required>
                                ...
                                <div class="form-group">
                                  <label class="col-lg-2 control-label">No. of People</label>
                                  <div class="col-lg-5">
    ...
    <label class="col-lg-2 control-label"></label>
        <div id="combo" class="col-lg-5">
<?php
include('includes/dbcon.php');
	
    $query=mysqli_query($con,"select * from combo where combo_name <> 'Daily' order by combo_name")or die(mysqli_error($con));
...
<script>
function bookchange() {
  var book_type = document.getElementById("exampleSelect1").value;
  if(book_type == "daily") {
	  $( "#combo" ).prop("style","display: none;");
	  $( "#occasion" ).prop("style","display: none;");
	  $( ".occasion" ).prop("required",false);
  }
  else {
	  $( "#combo" ).prop("style","display: block;");
	  $( "#occasion" ).prop("style","display: block;");
	  $( ".occasion" ).prop("required",true);
  }
}
  $(function () {
